  ...
  return (
    <aside className="w-60 bg-white border-r border-pink-100 flex flex-col shrink-0 h-full">
      ...
      <div className="px-3 py-3 border-t border-pink-50 space-y-0.5">
        <button
          className="w-full flex items-center gap-2.5 px-3 py-2.5 rounded-xl text-sm font-medium text-gray-500 hover:bg-pink-50 hover:text-pink-700 transition-all duration-150"
          onClick={onNavigate}
        >
          <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
