...
-- Migration 001: HopeDB Schema
-- Tables: product, salesDetail, priceHist
-- (employee, department, job, jobHistory, customer, sales, payment
--  are part of HopeDB but not required by the PMS application)
-- ============================================================
...
-- NOTE: salesDetail references a 'sales' table from HopeDB.
-- For the PMS, we create a minimal sales table as a dependency.
...
-- Insert salesDetail rows (subset used by PMS reports)
